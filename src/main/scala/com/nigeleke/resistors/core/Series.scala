...
public enum Series {
    ...
    E48(100, 105, 110, 115, 121, 127, 133, 140, 147, 154, 162, 169, 178, 187, 196, 205, 215, 226, 237, 249,
    ...
    E192(100, 101, 102, 104, 105, 106, 107, 109, 110, 111, 113, 114, 115, 117, 118, 120, 121, 123, 124, 126,
    ...
    public final List<Integer> baseValues;

    Series(int... baseValues) {
        this.baseValues = Arrays.asList(
                Arrays.stream(baseValues)
                        .boxed()
                        .toArray(Integer[]::new)
        );
    }
